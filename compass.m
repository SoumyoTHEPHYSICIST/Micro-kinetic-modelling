function dydt = compass(t,y)

% compAss is the function created to calculate the reaction rates and
...
% Rate = d[Species]/dt for each species.
...
Z4= kf(4)*y(1)*y(3) - kb(4)*y(2)*y(14);

Z5= kf(5)*y(1)*y(6) - kb(5)*y(9)*y(3);

Z6= kf(6)*y(1)*y(6) - kb(6)*y(2)*y(8);

Z7= kf(7)*y(1)*y(2) - kb(7)*y(10)*y(3);

Z8= kf(8)*y(1)*y(5) - kb(8)*y(11)*y(2);

Z9= kf(9)*y(5)*y(1) - kb(9)*y(7)*y(3);

Z10= kf(10)*y(5)*y(1) - kb(10)*y(12)*y(8);

Z11= kf(11)*y(4)*y(3) - kb(11)*y(5)*y(8);

Z12= kf(12)*y(4)*y(2) - kb(12)*y(13)*y(8);

Z13= kf(13)*y(11)*y(8) - kb(13)*y(4)*y(4);

Z14= kf(14)*y(7)*y(6) - kb(14)*y(13)*y(8);

Z15= kf(15)*y(7)*y(3) - kb(15)*y(14)*y(13);

Z16= kf(16)*y(3)*y(3) - kb(16)*y(14);

Z17= kf(17)*y(3)*y(6) - kb(17)*y(8);

Z18= kf(18)*y(3)*y(5) - kb(18)*y(11);

Z19= kf(19)*y(6)*y(6) - kb(19)*y(15);

Z20= kf(20)*y(6)*y(13) - kb(20)*y(7);

Z21= kf(21)*y(2)*y(2) - kb(21)*y(10);
...
dydt(2) = (Z1+Z4-Z7+Z6+Z8-Z12-Z21-Z22);

dydt(3) = (Z1-Z4+Z5+Z7+Z9-Z11-Z15-Z16-Z17-Z18);

dydt(4) = (-Z2-Z3-Z11-Z12+Z13);

dydt(5) = (Z2-Z8-Z9-Z10+Z11-Z18-Z22);

dydt(6) = (Z2-Z5-Z6-Z14-Z17-Z19-Z20);

dydt(7) = (Z3+Z9-Z14-Z15+Z20+Z22);
